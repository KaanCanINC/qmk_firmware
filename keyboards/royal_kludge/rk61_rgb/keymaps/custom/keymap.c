...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WINFN] = LAYOUT_60_ansi(
        ...
        KC_TRNS,    KC_BTN3,    KC_MS_U,    KC_BTN1,    KC_BTN2,    KC_TRNS,    KC_PSCR,    KC_SCRL,    KC_PAUS,    KC_TRNS,    KC_TRNS,    RGB_VAD,    RGB_VAI,    RGB_MOD,   
        KC_TRNS,    KC_MS_L,    KC_MS_D,    KC_MS_R,    KC_WH_U,    KC_TRNS,    KC_INS,     KC_HOME,    KC_PGUP,    KC_TRNS,    RGB_SPD,    RGB_SPI,                KC_TRNS,   
        KC_TRNS,                KC_TRNS,    KC_TRNS,    KC_WH_D,    KC_TRNS,    KC_TRNS,    KC_DEL,     KC_END,     KC_PGDN,    RGB_HUI,    KC_SLSH,    KC_MOUSE,   
        KC_TRNS,    KC_TRNS,    KC_TRNS,                                        KC_TRNS,                                        KC_RALT,    KC_APP,     KC_RCTL,    KC_TRNS
    ),


    [MOUSEBASE] = LAYOUT_60_ansi(
        KC_TILD,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_BASE,    KC_TRNS,
